# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-08-31 13:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ship_time', models.DateField(verbose_name='出厂时间')),
                ('end_time', models.DateField(verbose_name='到保时间')),
        ...
        migrations.AddField(
            model_name='asset',
            name='product_line',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='asset.product_lines', verbose_name='产品线'),
        ),
    ]
